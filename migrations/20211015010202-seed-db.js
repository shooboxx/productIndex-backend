...
module.exports = {
  up: async (queryInterface, Sequelize) => {
   ...
   create table "public".business_store_hours (Id serial not null, business_store_id int4 not null, monday_open time, monday_closed time, tuesday_open time, tuesday_closed time, wednesday_open time, wednesday_closed time, thursday_open time, thursday_closed time, friday_open time, friday_closed time, saturday_open time, saturday_closed time, sunday_open time, sunday_closed int4, insert_date timestamp not null, update_date timestamp, primary key (Id));
