...
module.exports = {
  async up (queryInterface, Sequelize) {
    return queryInterface.sequelize.query(
      `
      create table "public".business_activity (id serial not null, user_id int4 not null, business_id int4 not null, activity varchar(500) not null, insert_date timestamp, update_date timestamp, primary key (id));
      create table employee (id serial not null, business_id int4 not null, user_id int4 not null, business_access_level varchar(100) not null, employee_verify_code varchar(100), verified_date timestamp, deleted_date timestamp, insert_date timestamp, update_date timestamp, primary key (id));
      create table "public".employee_assignment (id serial not null, employee_id int4 not null, business_store_id int4 not null, insert_date timestamp, update_date timestamp, primary key (id));
