...
const r = require('./authRepo')

function getAllProducts() : AuthUser[] {
    let productList: AuthUser[] = []
    const product = {
        id: 0, 
        business_id: 0,
        product_key: 0,
...
const getProductByID = (id : number) : AuthUser => {
...
const getProductsByName = (productName : string) : AuthUser[] => {
