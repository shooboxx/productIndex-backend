...
router.get("/store/:storeId", async (req, res) => {
  try {
    ...
    const store = await businessStoreService.getStoreById(storeId);
...
router.get("/store/:storeId/details", async (req, res) => {
  try {
    const storeId = req.params.storeId;
    const store = await businessStoreService.getStoreDetails(storeId);
...
router.get("/store/:storeId/inventory", async (req, res) => {
    try {
      const storeId = req.params.storeId;
      const store = await businessStoreService.getStoreInventory(storeId);
...
router.delete("/store/:storeId", async (req, res) => {
  try {
    ...
    const store: BusinessStore = await businessStoreService.getStoreById(
      storeId
    );
